...
EnText[DataName.Greetings1] = "Welcome to the project !{{#E15061}}RedAge!{{#FFF}} and thank you from the bottom of our hearts for being with us now ❤️"; // NOT WORKING
 ...
 EnText[DataName.Greetings5] = "You can find a lot of useful information about the project on our Wikipedia - !{{#E15061}}wiki.redage.net!{{#FFF}}."; // NOT WORKING
