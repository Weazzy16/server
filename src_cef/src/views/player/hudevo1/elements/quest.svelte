    ...
    <div class="mission">
        <div class="active-mission">
            <div class="main-mission">
                <header class="column-block">
                    <div class="header-info">
                        <div class="header-info__title">{@html quest.Title}</div>
                        <div class="header-info__text">{keysName[$keys[12]]} - Информация</div>
                    </div>
                    <div class="progress"><div class="progress__line"></div></div>
                </header>
                <main>
                    <div class="main-content">
                        <div class="main-content__text">{@html quest.Text}</div>
                    </div>
                </main>
            </div>
        </div>
