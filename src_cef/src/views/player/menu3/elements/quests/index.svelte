...
<div id="questsnewlist">
        ...
        <div class="questsnewlist-bottom__left">
            ...
            <div class="questsnewlist-list">
                ...
                {#each QuestsList as questData, index}
                    <div class="questsnewlist-element" class:active={questData == quest} on:keypress={() => {}} on:click={() => quest = questData}>
                        <div class="box-flex">
    ...
    <div class="questsnewlist-bottom">
        <div class="box-KeyAnimation questsnewlist-margin-right" on:keypress={() => {}} on:click={onRoute}>
            <div>{translateText('player1', 'Построить маршрут')}</div>
            <KeyAnimation keyCode={13}>ENTER</KeyAnimation>
        </div>
        <div class="box-KeyAnimation" on:keypress={() => {}} on:click={onSelect}>
