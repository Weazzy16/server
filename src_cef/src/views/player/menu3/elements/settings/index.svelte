...
<div id ="sound__settings">
    <div class="settings__nav">
        ...
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Main"} class:active={SelectCategorie == "Main"}>— {translateText('settings', 'Настройки персонажа')}</div>
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Hud"} class:active={SelectCategorie == "Hud"}>— {translateText('settings', 'Настройки худа')}</div>
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Chat"} class:active={SelectCategorie == "Chat"}>— {translateText('settings', 'Настройки чата')}</div>
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Sound"} class:active={SelectCategorie == "Sound"}>— {translateText('settings', 'Настройки игры и звуков')}</div>
        <div class="settings__title">{translateText('settings', 'Дополнительные настройки')}</div>
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Pricel"} class:active={SelectCategorie == "Pricel"}>— {translateText('settings', 'Настройки прицела')}</div>
        <div class="settings__subtitle" on:keypress={() => {}} on:click={() => SelectCategorie = "Acc"} class:active={SelectCategorie == "Acc"}>— {translateText('settings', 'Настройки аккаунта')}</div>
    </div>
    <div class="settings__background">
        <div class="settings__header">
            ...
            <div class="box-column">
                ...
                <div class="settings__header_subtitle" on:keypress={() => {}} on:click={onDefaultButton}>{translateText('settings', 'Сбросить по умолчанию')}</div>
            </div>
        </div>
