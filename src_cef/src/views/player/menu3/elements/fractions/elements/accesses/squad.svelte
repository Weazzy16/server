...
<div class="box-between mr-20 align-startflex">
    <div class="box-column">
        ...
        <div class="fractions__main_scroll w-204 h-480">
            {#each departments as item}
                <div class="fractions__scroll_element hover p-20 fw-bold" on:keypress={() => {}} on:click={() => onSelectDepartmentId(item)}>
                    <div>{item.name}</div>
    ...
    <div class="box-column">
        <div class="fractions_stats_title mt-20">Ранг:</div>
        <div class="fractions__main_scroll w-240 h-480">
            {#if selectDepartmentId >= 0}
                {#each ranks as item}
                    <div class="fractions__scroll_element hover p-20 fw-bold" on:keypress={() => {}} on:click={() => onSelectId(item)}>
                        <div class="box-flex">
