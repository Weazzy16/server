...
<div class="box-flex mt-20">
    <div class="fractions__selector" class:active={selectView === "Missions"} on:keypress={() => {}} on:click={() => onSelectView ("Missions")}>
        {translateText('player1', 'Задания')}
    </div>
    <div class="fractions__selector" class:active={selectView === "Personal"} on:keypress={() => {}} on:click={() => onSelectView ("Personal")}>
        {translateText('player1', 'Персональные')}
    </div>
    <div class="fractions__selector" class:active={selectView === "Fraction"} on:keypress={() => {}} on:click={() => onSelectView ("Fraction")}>
