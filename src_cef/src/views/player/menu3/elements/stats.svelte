    ...
    <div class="box-column margin-right-20">
        <div class="box-bg box-width-352" style="align-items: center">
            ...
            <div class="info-box">
                ...
                <div class="info-line" />
                <span class="white">{selectCharData.VipLvl > 0 ? `${vipinfo[selectCharData.VipLvl]} (закончиться ${moment(selectCharData.VipDate).format('DD.MM.YYYY')})` : vipinfo[selectCharData.VipLvl]}</span>
            </div>
        ...
        <div class="box-flex">
            <div class="box-bg box-width-352 margin-right-20">
                ...
                <div class="info-box margin-top-18">
                    ...
                    <div class="info-line" />
                    <span class="white">{selectCharData.isAdmin ? "Administrator" : "Player"}</span>
                </div>
                <div class="info-box margin-top-18">
                ...
                <div class="info-box margin-top-18">
                    ...
                    <div class="info-line" />
                    <span class="white">{Bool(selectCharData.Gender) ? "Male" : "Female"}</span>
                </div>
                <div class="info-box margin-top-18">
