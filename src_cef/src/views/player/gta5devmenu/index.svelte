      ...
      <div class="headplayr">
        ...
        <ul class="menulist">
          ...
          <li
            class="namenav"
            tabindex="0"
            class:active={/Anim\d/.test(selectView)}
          >
            <div
              class="navblock"
            ...
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim0')} class:active={selectView === 'Anim0'}><div class="line vertical"></div><div class="line horizontal"></div><p>Избранное</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim1')} class:active={selectView === 'Anim1'}><div class="line vertical"></div><div class="line horizontal"></div><p>Сесть/Лечь</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim2')} class:active={selectView === 'Anim2'}><div class="line vertical"></div><div class="line horizontal"></div><p>Социальные</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim3')} class:active={selectView === 'Anim3'}><div class="line vertical"></div><div class="line horizontal"></div><p>Позы</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim4')} class:active={selectView === 'Anim4'}><div class="line vertical"></div><div class="line horizontal"></div><p>Неприличные</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim5')} class:active={selectView === 'Anim5'}><div class="line vertical"></div><div class="line horizontal"></div><p>Физ. упражнения</p></li>
            <li tabindex="0" on:click|stopPropagation={() => handleSelect('Anim6')} class:active={selectView === 'Anim6'}><div class="line vertical"></div><div class="line horizontal"></div><p>Танцы</p></li>
...
<!-- Сезонный пропуск -->
<li class="namenav" tabindex="0" class:active={openSeasonPass || /BP\d/.test(selectView)}>
...
<!-- Магазин -->
<li class="namenav" tabindex="0" class:active={openShop || ['Pay','Cases','Shopcl','Shoptaty','Shopcar','Money','Stock','Personal'].includes(selectView)}>
  ...
  <ul class="dropdown" style="max-height: {openShop ? '680px' : '0'};">
    <li tabindex="0" on:click|stopPropagation={() => handleSelect('Pay')} class:active={selectView === 'Pay'}><div class="line vertical"></div><div class="line horizontal"></div><p>Пополнить</p></li>
    ...
    <li tabindex="0" on:click|stopPropagation={() => handleSelect('Shoptaty')} class:active={selectView === 'Shoptaty'}><div class="line vertical"></div><div class="line horizontal"></div><p>Тату</p></li>
...
<li class="namenav" tabindex="0" class:active={selectView === 'General'}>
  <div class="navblock" on:click={() => handleSelect('General')} on:keypress={(e) => e.key === 'Enter' && handleSelect('General')}>
    <!-- icon placeholder -->
    <svg class="icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
