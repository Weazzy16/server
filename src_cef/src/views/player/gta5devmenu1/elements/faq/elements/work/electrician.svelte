...
<div class="rulesblockbg">
    ...
    <p><span style="font-weight: 400;">После трудоустройства необходимо отправиться на электростанцию <strong>(⬆ -&gt; Работы -&gt; Электростанция)</strong>. Можно арендовать автомобиль на стоянке транспорта, или, например, вызвать такси <strong>(⬆ -&gt; Звонки -&gt; Вызывать такси)</strong>.</span></p>
    ...
    <h1><div class="btn" on:click={onWayPoint}>Показать на карте <span class="icon map"/></div></h1>
</div>