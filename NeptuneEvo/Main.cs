...
namespace NeptuneEvo
{
    ...
    {
        public static string Codename { get; } = "Grey Classic";
        public static string Version { get; } = "v1.00.00";
        public static string Build { get; } = "build: 1.2";
        public static string Full { get; } = $"{Codename}  {Build}";
        ...
        public static MetaldetectorPrice MetaldetectorPrice = new MetaldetectorPrice();
        ...
        public static void LoadServerSettings()
        {
            ...
            MetaldetectorPrice = Settings.ReadAsync("MetaldetectorPrice", MetaldetectorPrice);
            ...
            Manager.FractionDataMats[100].Price = $"{Main.PricesSettings.Instrument2Prices[0]}$";
            Manager.FractionDataMats[101].Price = $"{Main.PricesSettings.Instrument2Prices[1]}$";
        ...
        public static void SaveServerSettings()
        {
            ...
            Settings.Save("MetaldetectorPrice", MetaldetectorPrice);
        ...
        #region ClientEvents
        [RemoteEvent("__ragemp_cheat_detectedds")]
            ...
            
            {
                ...
                foreach (ExtPlayer foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    if (foreachCharacterData.DemorganTime <= 0)
                    {
                        ...
                        {
                            case 120:
                                OnlineReward(foreachPlayer, 2, 100);
                                break;
                            case 180:
                                ...
                                break;
                            case 240:
                                OnlineReward(foreachPlayer, 4, 200);
                                break;
                            case 300:
                                ...
                                break;
                            case 480:
                                OnlineReward(foreachPlayer, 6, 400);
                    ...
                    {
                        UpdateData.RedBucks(foreachPlayer, 5000, msg: "Вознаграждение за месячный онлайн");
                        ...
                        lock (PromoCodes)
                        {
                            ...
                            if (pcdata.RewardLimit == 0 || pcdata.RewardReceived < pcdata.RewardLimit)
                            {
                                ...
                                if (pcdata.CreatorUUID != 0)
                                {
                                    ...
                                    if (target != null)
                                    {
                                        MoneySystem.Wallet.Change(target, 5000000);
            ...
            try
            {
                ...
                foreach (ExtPlayer foreachPlayer in Character.Repository.GetPlayers())
                {
                    try
                    {
                        ...
                        {
                            UpdateData.RedBucks(foreachPlayer, 200, msg:String.Empty);
                        ...
                        {
                            UpdateData.RedBucks(foreachPlayer, 500, msg:String.Empty);
        ...
        public static bool IsDebugEvents = true;
