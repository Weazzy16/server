...
namespace NeptuneEvo.Jobs
{
    class Truckers : Script
    {
        ...
        public static List<Vector3> OutProduct = new List<Vector3>()
        {
            new Vector3(66.49058, 6339.7803, 31.218979)
        };
        public static List<string> vehiclesWithAcception = new List<string>()
        {
            "pounder", "benson", "rallytruck", "g636x6", "dubsta", 
        };
        ...
        public void OnPlayerEnterVehicle(ExtPlayer player, ExtVehicle vehicle, sbyte seatId)
        {
            ...
            if (sessionData.OrderData.WayPoint != null)
            {
                ...
                Trigger.ClientEvent(player, "createWaypoint", OutProduct[0].X, OutProduct[0].Y);
            }
        }
        ...
        public static void playerGotProducts(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    Trigger.ClientEvent(player, "createWaypoint", OutProduct[0].X, OutProduct[0].Y);
                    Trigger.ClientEvent(player, "createCheckpoint", 10, 1, OutProduct[0] - new Vector3(0.0, 0.0, 1.5), 7, 0, 255, 0, 0);
                    NAPI.Task.Run(() => 
                    {
                        CustomColShape.CreateCylinderColShape(OutProduct[0], 7f, 7f, 0, ColShapeEnums.Trucker, biz.ID);
                    });
        ...
        [Interaction(ColShapeEnums.Trucker)]
