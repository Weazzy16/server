...
namespace NeptuneEvo.Houses
{
    class Svalka : Script
    {
        //private static Vector3 Svalki[i] = new Vector3(-469.10852, -1717.8014, 17.569134);
        private static nLog Log = new nLog("Свалка");

        public static List<Vector3> Svalki = new List<Vector3>
        {
        new Vector3(-469.10852, -1717.8014, 17.569134),
        //new Vector3(831.7186, -3346.0115, 17.569134),
