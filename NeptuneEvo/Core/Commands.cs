    ...
    class Commands : Script
    {
        ...
        public static void CMD_ammo(ExtPlayer player, int ID, int type, int amount = 1)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) выдал патроны ({type}|{amount}) {target.Name} ({target.Value})");
            }
            catch (Exception e)
            {
        ...
        public static void CMD_setDim(ExtPlayer player, int id, int dim)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) выставил Dimension({dim}) {target.Name} ({targetCharacterData.UUID})");
        ...
        public static void CMD_offlineDelFraction(ExtPlayer player, string name)
        {
            try
            {
                ...
                Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) уволил из фракции {name}");
        ...
        public static void CMD_respawnCars(ExtPlayer player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) отправил все машины на спавн ({countToSpawn} шт.)");
        ...
        public static void CMD_respawnCar(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) отправил машину на спавн ({vehicle.Value})");
            ...
            try
            {
                ...
                foreach (ExtVehicle veh in vehs)
                {
                    ...
                    if (vehicleLocalData != null)
                    {
                        ...
                        Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) отправил машину на спавн ({veh.Value})");
        ...
        */
        ...
        public static void CMD_fixcar(ExtPlayer player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) починил машину ({vehicle.Value})");
        ...
        public static void CMD_fixcarID(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (ExtVehicle veh in vehs)
                {
                    ...
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) починил машину по ID ({veh.Value})");
        ...
        public static void CMD_showPlayerStats(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (targetCharacterData.AdminLVL >= 6)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.CantFindPlayerWithId), 3000);
                        Notify.Send(target, NotifyType.Alert, NotifyPosition.BottomCenter, $"{player.Name} ({characterData.UUID}) попытался посмотреть Вашу статистику (/stats)", 3000);
                        return;
                    }
                }
                ...
                Trigger.ClientEvent(player, "client.inventory.Open");
                sessionData.LookingStats = true;
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) смотрит статистику {target.Name} ({target.Value})");
            }
            catch (Exception e)
            {
        ...
        public static void CMD_AllAdmins(ExtPlayer player)
        {
            try
            {
                ...
                Trigger.SendChatMessage(player, "=== ADMINS ONLINE ===");
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) проверяет список администрации в сети");
            }
            catch (Exception e)
            {
        ...
        public static void CMD_AllMedias(ExtPlayer player)
        {
            try
            {
                ...
                Trigger.SendChatMessage(player, "=== MEDIA ONLINE ===");
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) проверяет список медиа в сети");
            }
            catch (Exception e)
            {
        ...
        public static void CMD_Clear(ExtPlayer player, int id)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) снял розыск {target.Name} ({target.Value})");
        ...
        public static void CMD_Agl(ExtPlayer player, int id)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) выдал комплект лицензий {target.Name} ({target.Value})");
        ...
        public static void CMD_tpCoord(ExtPlayer player, string cords)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) телепортировался по координатам {resultCords[0]} {resultCords[1]} {resultCords[2]}");
        ...
        public static void CMD_SendToCreator(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (characterData.AdminLVL >= 6 || Admin.SendCreatorQueue.ContainsKey(target))
                {
                    if (characterData.AdminLVL >= 6)
                    {
                        Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) отправил в creator {target.Name} ({target.Value})");
                    ...
                    else
                    {
                        ...
                        Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) подтвердил запрос смены внешности от администратора {Admin.SendCreatorQueue[target].Item1}");
                ...
                else
                {
                    ...
                    Trigger.SendToAdmins(2, $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({characterData.UUID}) на смену внешности {target.Name}. Чтобы подтвердить действие - введите: /sendcreator {id}");
                }
            }
            catch (Exception e)
            {
        ...
        public static void CMD_vehchage(ExtPlayer player, string newmodel)
        {
            try
            {
                ...
                var pdata = player.GetCharacterData();
                foreach (string joke in NeptuneEvo.Core.VehicleManager.SpecialVehs)
                {
                    if (newmodel.Contains(joke) && pdata.UUID != 1) return;
                }
                if (!player.IsInVehicle) return;
                var vehicle = (ExtVehicle) player.Vehicle;
                var vehicleLocalData = vehicle.GetVehicleLocalData();
        ...
        public static void CMD_setVehiclePetrol(ExtPlayer player, int fuel)
        {
            try
            {
                ...
                if (characterData == null) return;
                if (!player.IsInVehicle) return;
                if (characterData.AdminLVL <= 1 && (fuel >= 200 || fuel < 0))
                {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) заправил машину ({player.Vehicle.Value},{fuel}л)");
                }
            }
            catch (Exception e)
            {
        ...
        public static void CMD_Afuelall(Player player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) заправил все машины");
        ...
        */
        ...
        public static void CMD_changeNamebyId(ExtPlayer player, int id, string newName)
        {
            try
            {
                ...
                if (characterData.AdminLVL >= 5 || (Admin.ChangeNameQueue.ContainsKey(curient) && Admin.ChangeNameQueue[curient].Item1 == newName))
                {
                    ...
                    {
                        Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) изменил имя {curient} на {newName}");
                    ...
                    else
                    {
                        ...
                        Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) подтвердил запрос изменения администратора {Admin.ChangeNameQueue[curient].Item2}");
                ...
                else
                {
                    ...
                    Trigger.SendToAdmins(2, $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({characterData.UUID}) на смену имени {curient} -> {newName}. Чтобы подтвердить действие - введите: /setname {curient} {newName}");
                }
            }
            catch (Exception e)
            {
        ...
        public static void CMD_changeName(ExtPlayer player, string curient, string newName)
        {
            try
            {
                ...
                if (characterData.AdminLVL >= 6 || (Admin.ChangeNameQueue.ContainsKey(curient) && Admin.ChangeNameQueue[curient].Item1 == newName))
                {
                    ...
                    if (characterData.AdminLVL >= 6)
                    {
                        Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) изменил имя {curient} на {newName} в оффлайне");
                        GameLog.Admin($"{player.Name}", $"changeName({newName})", $"{curient}");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Ник изменен!", 3000);
                    }
                    else
                ...
                else
                {
                    ...
                    Admin.ChangeNameQueue.Add(curient, (newName, player.Name, characterData.AdminLVL));
                    Trigger.SendToAdmins(2, $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({characterData.UUID}) на смену имени {curient} -> {newName}. Чтобы подтвердить действие - введите: /setnameoff {curient} {newName}");
                }
            }
            catch (Exception e)
            {
        ...
        public static void CMD_giveLvl(ExtPlayer player, int id, int lvl)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) выдал {target.Name} ({target.Value}) {lvl} уровней");
        ...
        public static void CMD_deleteThisAdminCar(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    {
                        Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) удалил админ-машину ({vehicle.Value})");
                        VehicleStreaming.DeleteVehicle(vehicle);
        ...
        public static void CMD_delMyCars(ExtPlayer player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) удалил все админ-машины");
        ...
        public static void CMD_Delmyveh(ExtPlayer player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) удалил все свои админ-машины");
        ...
        [Command("setfracvehpos")]
        public static void ACMD_setfracvehpos(ExtPlayer player, bool isMessage = true)
        {
            try
            {
                if (!CommandsAccess.CanUseCmd(player, AdminCommands.Setfracveh)) return;
        ...
        public static void CMD_Spawn(ExtPlayer player, int id)
        {
            try
            {
                ...
                { 
                    ...
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) отправил на спавн {target.Name} ({target.Value})");
        ...
        public static void CMD_adminHeal(ExtPlayer player)
        {
            try
            {
                ...
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) повысил себе здоровье");
        ...
        public static void CMD_adminArmor(ExtPlayer player, int id, int ar)
        {
            try
            {
                Admin.armorTarget(player, Main.GetPlayerByUUID(id), ar);
            }
            catch (Exception e)
            {
        ...
        public static void CMD_adminGuns(ExtPlayer player, int id, string wname, string serial)
        {
            try
            {
                Admin.giveTargetGun(player, Main.GetPlayerByUUID(id), wname, serial);
            }
            catch (Exception e)
            {
        ...
        public static void CMD_createVehicle(ExtPlayer player, string name, int a, int b)
        {
            try
            {
                ...
                foreach (string joke in NeptuneEvo.Core.VehicleManager.SpecialVehs)
                {
                    if (name.Contains(joke) & pdata.UUID != 1) return;
                }
                if (characterData == null) return;
                ExtVehicle veh;
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) создал машину({name},{veh.Value})");
            ...
            try
            {
                ...
                if (count >= 1 && count <= 20)
                {
                    ...
                    if (vehHash != 0)
                    {
                        ...
                        Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) создал {count} машин({name})");
                        GameLog.Admin($"{player.Name}", $"vehsCreate({count} {name})", $"");
                    }
                    else
                    {
                        if (characterData.AdminLVL <= 3) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Транспорта с таким названием не было найдено", 3000);
                        else
                        {
        ...
        public static void CMD_Carnumber(ExtPlayer player, string number) {
            try
            {
                ...
                if (vehicleData != null)
                {
                    ...
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) проверяет владельца машины {number} ({vehicleData.Holder})");
                }
        ...
        public static void CMD_setTime(ExtPlayer player, short hours, short minutes, short seconds)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) установил игровое время({hours} {minutes} {seconds})");
        ...
        public static void CMD_teleport(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (targetCharacterData.AdminLVL >= 6)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.CantFindPlayerWithId), 3000);
                        Notify.Send(target, NotifyType.Alert, NotifyPosition.BottomCenter, $"{player.Name} ({characterData.UUID}) попытался телепортироваться к Вам (/tp)", 3000);
                        return;
                    }
                }
                Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) телепортировался к {target.Name} ({target.Value})", 1, "#636363");
        ...
        public static void CMD_Metpcar(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) телепортировал машину к себе {veh.DisplayName} ({id})", 1, "#636363", hideAdminLevel: 9);
        ...
        public static void CMD_tpTocar(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) телепортировался к машине {veh.DisplayName} ({id})", 1, "#636363", hideAdminLevel: 9);
        ...
        public static void CMD_tpcarnumber(ExtPlayer player, string veh_number)
        {
            try
            {
                ...
                foreach (ExtVehicle veh in vehs)
                {
                    ...
                    Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) телепортировался к машине {veh.DisplayName} (ID: {veh.Value}; Number: {veh.NumberPlate})", 1, "#636363", hideAdminLevel: 9);
                    NAPI.Entity.SetEntityPosition(player, veh.Position);
                    Trigger.Dimension(player, UpdateData.GetVehicleDimension(veh));
        ...
        public static void CMD_Setdimcar(ExtPlayer player, int id, int newDimensionNumber)
        {
            try
            {
                ...
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) изменил dimension машины {veh.DisplayName} ({id}) на {newDimensionNumber}.", 1, "#636363", hideAdminLevel: 9);
        ...
        public static void Uncrimeban(ExtPlayer player, int pid)
        {
            try
            {
                ...
                if (target != null && targetCharacterData != null)
                {
                    ...
                    Trigger.SendToAdmins(1, $"~r~[A] {player.Name} ({characterData.UUID}) разблокировал в системах capture и bizwar персонажа {target.Name} ({target.Value})");
        ...
        public static void CMD_flipveh(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    if (veh.Value != id) continue;
                    Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) перевернул машину {veh.DisplayName} ({id})");
        ...
        public static void CMD_Offunjail(ExtPlayer player, string targetName)
        {
            try
            {
                ...
                //Admin.AdminLog(characterData.AdminLVL, $"{player.Name} ({characterData.UUID}) освободил из админ.тюрьмы {target}");
        ...
        [Command(AdminCommands.Banplayer, GreedyArg = true)]
        ...
        [Command(AdminCommands.Hardbanda, GreedyArg = true)]
        ...
        [Command("fakeuuid")]
        public static void CMD_fakeUuid(ExtPlayer player, int uuid)
        {
            var cdata = player.GetCharacterData();
            if (cdata.UUID != 1) return;
            player.ResetData("Personal_ID");
            player.SetSharedData("Personal_ID", uuid);
        }
        [Command(AdminCommands.offid)]
        public static void CMD_offid(ExtPlayer player, int uuid)
        {
            try
            {
                if (!CommandsAccess.CanUseCmd(player, AdminCommands.offid)) return;
                var first = "";
                var second = "";
                using MySqlCommand cmdSELECT = new MySqlCommand
                {
                    CommandText = $"SELECT firstname, lastname FROM characters WHERE uuid=@val0"
                };
                ...
                {
                    var accRow = resultSELECT.Rows[0];
                    first = accRow["firstname"].ToString();
                    second = accRow["lastname"].ToString();
                    Trigger.SendChatMessage(player, $"Игрок {first}_{second}#{uuid}");
                }
            }
            catch (Exception e)
            {
        ...
        public static void CMD_ELog(ExtPlayer player)
        {
            try
            {
                ...
                if (characterData == null) 
                    return;
                else if (characterData.AdminLVL < 9) 
                    return;
        ...
        public static void LeaveFractionOrg(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (index == 0)
                {
                    ...
                    var characterData = player.GetCharacterData();
                    Manager.sendFractionMessage(memberFractionData.Id, "!{#FF8C00}[F] " + $"{player.Name} ({characterData.UUID}) уволился по собственному желанию.", true);
        ...
        public static void CMD_gov(ExtPlayer player, string msg)
        {
            try
            {
                ...
                if(Main.stringGlobalBlock.Any(c => testmsg.Contains(c)))
                {
                    ...
                    Trigger.SendToAdmins(3, $"{ChatColors.StrongOrange}[A] {player.Name} ({characterData.UUID}) попытался написать в гос.связь: {msg}");
        ...
        public static void CreateRefCode(ExtPlayer player)
        {
            try
            {
                ...
                string message = "!{#636363}[A] " + $"Игрок {player.Name} ({characterData.UUID}) создал реф. код: " + code;
        ...
        {   
            try
            {
                ...
                string message = "!{#636363}[A] " + $"Игрок {player.Name} ({characterData.UUID}) написал в action: " + msg;
                Trigger.SendToAdmins(1, message);
            }
            catch (Exception e)
            {
