        ...
        public void onResourceStart()
        {
            try
            {
                ...
                */
                ...
                NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("h4_prop_h4_gate_r_03a"), new Vector3(4981.012, -5712.747, 20.78103), 30f);
                NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("h4_prop_h4_gate_l_03a"), new Vector3(4984.134, -5709.249, 20.78103), 30f);
                NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("h4_prop_h4_gate_r_03a"), new Vector3(4990.681, -5715.106, 20.78103), 30f);
                NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("h4_prop_h4_gate_l_03a"), new Vector3(4987.587, -5718.635, 20.78103), 30f);
