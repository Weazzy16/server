    ...
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                PedSystem.Repository.CreateQuest("s_m_m_marine_01", new Vector3(-2328.3489, 3397.3276, 30.67922), -50.05095f, title: "~y~NPC~w~ Рекрут Астраханский\nВызвать сотрудника", colShapeEnums: ColShapeEnums.CallArmyMember);
            }
        ...
        {
            new Vector3(-2345.9026, 3268.0806, 31.8), // guns     0
            new Vector3(-2350.477, 3261.8386, 31.7), // dressing room    1
            new Vector3(-2447.851, 2967.4094, 31.78082), // army docks mats     2
            new Vector3(-2360.946, 3249.595, 31.81073), // army lift 1 floor     3
            new Vector3(-2360.66, 3249.115, 91.90369), // army lift 9 floor     4
            new Vector3(-2358.3594, 3255.1467, 31.810738), // army stock    5
            new Vector3(-2291.215, 3348.303, 32.954926), // Починка наземного транспорта 6
            new Vector3(-2146.249, 3227.8186, 31.81027), // Починка воздушного транспорта 7
            new Vector3(-2348.5144, 3270.5317, 31.810726), // Общая тревога кнопка 8
                ...
                switch (interact)
                {
                    ...
                    case 7: // Общая тревога
                        ...
                        foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        {
                            ...
                            Manager.sendFractionMessage(6, $"~r~{message}!!!");
                            Manager.sendFractionMessage(7, $"~r~{message}!!!");
                            Manager.sendFractionMessage(9, $"~r~{message}!!!");
                            Manager.sendFractionMessage(14, $"~r~{message}!!!");
                        }
                        return;
                    case 8: {
