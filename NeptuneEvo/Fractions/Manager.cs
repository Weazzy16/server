...
namespace NeptuneEvo.Fractions
{
    class Manager : Script
    {
        ...
        public static IReadOnlyDictionary<int, Vector3> FractionSpawns = new Dictionary<int, Vector3>()
        {
            ...
            {(int) Models.Fractions.ARMY, new Vector3(-2351.7065, 3259.7698, 32.810715)},    // Army
        ...
        public static IReadOnlyDictionary<int, string> FractionNames = new Dictionary<int, string>()
        {
            ...
            {(int) Models.Fractions.SHERIFF, "Каратели" },
        };
        //
        ...
        public static Dictionary<int, FracMatsData> FractionDataMats = new Dictionary<int, FracMatsData>()
        {
            ...
            { 94, new FracMatsData(94, Chars.Repository.ItemsInfo[ItemId.Camera2].Name, Chars.Repository.ItemsInfo[ItemId.Camera2].Icon, null) },
             ...
             //Метало магазин
            { 100, new FracMatsData(100, Chars.Repository.ItemsInfo[ItemId.Metaldetector].Name, Chars.Repository.ItemsInfo[ItemId.Metaldetector].Icon, Main.PricesSettings.Instrument2Prices[0]+"$") },
            { 101, new FracMatsData(101, Chars.Repository.ItemsInfo[ItemId.Shovel].Name, Chars.Repository.ItemsInfo[ItemId.Shovel].Icon, Main.PricesSettings.Instrument2Prices[1]+"$") },
    ...
    class Stocks : Script
    {
        ...
        public static Dictionary<int, Vector3> matsCoords = new Dictionary<int, Vector3>()
        {
            ...
            { (int) Models.Fractions.ARMY, new Vector3(-2328.916, 3248.0217, 32.049824)},
            { (int) Models.Fractions.LSNEWS, new Vector3()},
        ...
        {
            { (uint)VehicleHash.Barracks, 20000 },
    ...
    class MatsWar : Script
    {
        ...
        private static Vector3 warPosition = new Vector3(-2062.0103, 3196.759, 32.795883);
