...
{ 
    ...
    { 
        ...
        public static Vector3 FirstPosition = new Vector3(5012.5796, -5744.007, 18.880352);  // Оружие
        public static Vector3 CloakroomPosition = new Vector3(5026.7314, -5736.5312, 17.865582);  // форма
        private static Vector3 CloakroomSpecialPosition = new Vector3(1848.5563, 3695.9812, 34.26695); // форма ЧП 
        private static Vector3 VehicleBoostPosition = new Vector3(4942.1436, -5671.8994, 21.42286); 
        ...
        private static Vector3 SecondStockPosition = new Vector3(5029.19, -5734.6436, 17.865582); 
        private static Vector3 VehicleRepairPosition = new Vector3(4944.3257, -5686.8057, 21.473543); 
         
        public static Vector3 FirstGunsPosition = new Vector3(5012.5796, -5744.007, 19.880352);  // Оружие
        ...
        { 
            try 
            { 
                Main.CreateBlip(new Main.BlipData(472, "Каратели", FirstPosition, 38, true)); 
              ...
              //  Ped ped = PedSystem.Repository.CreateQuest("s_f_y_sheriff_01", new Vector3(1852.9309, 3688.9907, 34.266937), -150.65309f, title: "~y~NPC~w~ Виктория Ньютон\nСекретарь", colShapeEnums: ColShapeEnums.FracSheriff); 
                ...
                PedSystem.Repository.CreateQuest("s_m_m_highsec_01", FirstGunsPosition, -87.25532f, title: "~y~NPC~w~ Санчес\nСкладской", colShapeEnums: ColShapeEnums.FracSheriff); 
