    ...
    class qMain : Script
    {
        ...
        public static void QuestPerform(ExtPlayer player, bool isClose)
        {
            try
            {
                ...
                else if (questData.ActorName == "npc_metaldetectorshop") Metaldetector.Perform(player, 1);
                else if (questData.ActorName == "npc_treasuresell") Metaldetector.Perform(player, 2);
