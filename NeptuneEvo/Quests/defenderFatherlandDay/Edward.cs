...
namespace NeptuneEvo.Quests
{
    ...
    class Edward : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                PedSystem.Repository.CreateQuest("s_m_y_barman_01", new Vector3(-1692.0126, -743.00085, 10.183417), 148.7835f, questName: "npc_fd_edward", title: "~y~NPC~w~ Молодняк Кислота\nКвестовый персонаж", colShapeEnums: ColShapeEnums.QuestPavel, isBlipVisible: false);
            }
            catch (Exception e)
            {
