...
namespace NeptuneEvo.Functions
{
    ...
    public static class AdminCommands
    {
        ...
        public const string offid = "offid";
        ...
        public const string Hardbanda = "hardban";
    ...
    class CommandsAccess : Script
    {
        ...
        private static string DefaultAdminAccess = JsonConvert.SerializeObject(new Dictionary<string, sbyte>()
        {
            ...
            { AdminCommands.Spawn, 1 },
            { AdminCommands.Fixcar, 1 },
            { AdminCommands.Fixcarid, 1 },
            { AdminCommands.Spveh, 1 },
            { AdminCommands.Spvehid, 1 },
            { AdminCommands.Tp, 1 },
            { AdminCommands.Afuel, 1 },
            ...
            { AdminCommands.Veh, 2 },
            { AdminCommands.Delveh, 2 },
            { AdminCommands.offid, 2 },

            { AdminCommands.Banplayer, 3 },
            ...
            { AdminCommands.Givereds, 9 },
            { AdminCommands.Giveredsall, 10 },
            { AdminCommands.Offgivemoney, 9 },
            { AdminCommands.Givemoney, 9 },
        ...
        //public static string[] LoginsDirector = new string[0] { };
