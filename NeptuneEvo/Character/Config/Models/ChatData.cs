...
namespace NeptuneEvo.Character.Config.Models
{
    public class ChatData
    {
        ...
        public byte VolumeQuest { get; set; } = 100; // 100
        public byte VolumeAmbient { get; set; } = 100; // 100
        public byte VolumePhoneRadio { get; set; } = 100; // 100
        public byte VolumeVoice { get; set; } = 100; // 100
        public byte VolumeRadio { get; set; } = 100; // 100
        public byte DistancePlayer { get; set; } = 100; // 100
        public byte DistanceVehicle { get; set; } = 100; // 100
