...
namespace NeptuneEvo.Accounts.Recovery
{
    class Repository
    {
        ...
        private static string _mailFrom = "support@gta5-storm.space";
        ...
        private static string _Password = "SErega11";
        public static int _port = 25;
