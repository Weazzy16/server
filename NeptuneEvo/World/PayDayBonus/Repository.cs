        ...
        public static void Bonus()
        {
            ...
            if (players.Count > 0)
            {
                ...
                foreach (var foreachPlayer in winnersPlayer)
                {
                    ...
                    Trigger.ClientEvent(foreachPlayer, "hud.info", "Удача на твоей стороне!", $"Поздравляем с победой в розыгрыше! {Main.DonateSettings.HappyHoursRB} RedBucks уже зачислены на твой аккаунт.", "СЧАСТЛИВЫЕ ЧАСЫ", "http://cdn.gta5-storm.space/cloud/img/time.png");
